        ...
        <div class="modal-content">
            ...
            {{ Form::open(['url'=>'cortes','method' => 'post']) }}
                <div class="modal-body">
                    @if($numVentas[0]->count || $numAbonos[0]->count)
                        <div class="form-group">
                            <label for="apertura">Apertura de caja $:</label>
                            <input type="number" class="form-control text-center" step="any" min="0" value="0" name="apertura" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control text-center" step="any" min="0" value="0" name="caja" required>
                        </div>
                    @else
                        <h3>No hay ventas ni abonos en este turno</h3>
                    @endif
                </div>
