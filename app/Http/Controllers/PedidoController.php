...
class PedidoController extends Controller
{
    ...
    {
        $desechables = Inventario::where([['tipo','=','Desechable'],['status','=','Activo']])->pluck('nombre','id');
    ...
    public function edit($id)
    {
        ...
        return view('pedido.edit',compact('venta','detalleVenta','cliente','desechables'));
    }
    ...
    public function descuento(Request $request){
        $credentials = [
            'name' => 'Chustru',
            'password' => $request->get('passadmin')
        ];
